...
int quot500, quot100, quot50, quot10; //quotient : 몫
int rema500, rema100, rema50; //remainder : 나머지
QString strmoney; //잔돈 money 문자열 변환
QString strquot500, strquot100, strquot50, strquot10; //string+quotient : 몫 문자열 변환

void Widget::on_pbReset_clicked()
{

    quot500 = money / 500; //500 배수 갯수
    rema500 = money % 500; //500 배수 제외 나머지

    quot100 = rema500 / 100; //100 배수 갯수
    rema100 = money % 100; //100 배수 제외 나머지

    quot50 = rema100 / 50; //50 배수 갯수
    rema50 = money % 50; //50 배수 제외 나머지

    quot10 = rema50 / 10; //10 배수 갯수
